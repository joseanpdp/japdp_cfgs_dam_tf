...
/**
 * Carga datos de demostración en la base de datos del proyecto.
 * Implementa CommandLineRunner para ejecutar la carga de los datos al iniciar la aplicación.
 * Realiza operaciones de inserción en las tablas de usuarios, clientes, productos, 
 * categorías, pedidos y detalles.
 */
@Component
public class DemoDatabaseLoader implements CommandLineRunner {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(DemoDatabaseLoader.class);
	...
	public void run(String... args) throws Exception {
		...
		User user = new User("jose", "jose@example.es", "321", "Jose descrito", "2024-02-02");
		userRepository.save(user);
				
		// Application
		
		
		LOGGER.debug("Cargando los base de datos con datos de demostración");
		
		Customer cus1 = new Customer("Carlos", "Invierno", "Sevilla");
		customerRepository.save(cus1);
		Customer cus2 = new Customer("Felipe", "Primavera", "Málaga");
		customerRepository.save(cus2);
		Customer cus3 = new Customer("Juan", "Otoño", "España");
		...
		Product prod13 = new Product("Almendras sin piel al punto de sal", 3.10f, "Paquete 100 g", cat2, 200);
		productRepository.save(prod13);
		Product prod14 = new Product("Almendras con piel al punto de sal", 2.70f, "Paquete 150 g", cat2, 200);
		...
		Product prod20 = new Product("Té negro", 1.10f, "Caja 30 bolsitas", cat3, 120);
		productRepository.save(prod20);
		Product prod21 = new Product("Té Chai", 1.30f, "Caja 40 bolsitas", cat3, 80);
		...
		Product prod24 = new Product("Costillas de Cerdo", 12.00f, "Paquete 2 kilos", cat4, 40);
		productRepository.save(prod24);
		Product prod25 = new Product("Galletas de Chocolate", 3.50f, "Paquete 250 g", cat5, 100);
		productRepository.save(prod25);
		Product prod26 = new Product("Galletas de Avena", 2.80f, "Paquete 300 g", cat5, 100);
		...
		Order order1 = new Order(cus1, "2024-12-23", "Almería");
		orderRepository.save(order1);
		Order order2 = new Order(cus1, "2024-01-11", "Cordoba");
		orderRepository.save(order2);
		Order order3 = new Order(cus2, "2024-01-07", "Cádiz");
		orderRepository.save(order3);
		Order order4 = new Order(cus2, "2024-02-11", "Huelva");
