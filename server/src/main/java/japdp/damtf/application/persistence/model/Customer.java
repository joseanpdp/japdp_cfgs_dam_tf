...
/**
 * La clase Customer representa a un cliente en el sistema. Cada cliente 
 * tiene un identificador único, un nombre, un apellido y una dirección. 
 * Estos atributos proporcionan información básica sobre el cliente.
 */
@NoArgsConstructor
@AllArgsConstructor
@Getter
